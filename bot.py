...
class Bot:
    ...
    def get_followers_by_target(self, username, amount: int = 0) -> Dict[int, UserShort]:
...
if __name__ == '__main__':
    bot = Bot()
    data = bot.get_followers_usernames()
    data = bot.get_followers_by_target("wpgsymphony")
